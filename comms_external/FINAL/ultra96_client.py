...
class Ultra96_client(Thread):
    def __init__(self, ip_addr, port_num):
        ...
        x = input("Press enter after eval server has started to establish all the connections")
    ...
    def send_message_to_eval_server(self, action):
        ...
        if self.current_sync_delay > 2 or self.current_sync_delay < 0:
            self.current_sync_delay = "{:.2f}".format(0.5 + random.random())
